...
const steps = [
  { num: "01", title: "Choose a Service", desc: "Browse from 50+ home services across all categories", icon: "🔍" },
  { num: "02", title: "Pick Your Slot", desc: "Schedule at your convenience — same day or in advance", icon: "📅" },
  { num: "03", title: "Pro Arrives", desc: "Verified expert arrives on time with all tools", icon: "🏠" },
  { num: "04", title: "Pay & Rate", desc: "Secure payment. Rate your experience after completion", icon: "💳" },
];
  ...
  return (
    <section id="how-it-works" className="px-4 sm:px-[5vw] py-16 sm:py-24 bg-white/[0.01] border-t border-white/5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 max-w-[1200px] mx-auto">
        {steps.map((s, i) => (
          <div key={i} style={{ position: "relative", textAlign: "center", padding: "20px" }}>
